...
export default function AA_MvDisplay() {
  return (
    ...
    <section className="aa-mv-container white-space section-MarginBottom">
      ...
      <AA_MissionVision AaimageSrc="assets/images/About/mission-and-vision/mission-image.webp" Aaborder="aa-right" Aareverse={false}
      ...
      <AA_MissionVision AaimageSrc="assets/images/About/mission-and-vision/vision-image.webp" Aaborder="aa-left" Aareverse={true}
