...
function OurBenefitsSection() {
  ...
  return (
    <div className="Ob-section-container">
        ...
        <div className="OB-card-container">
          {exportedBFCardData.map((ele, index)=>{
            return(
              <BenefitsCard key={index} sizeIco={76} srcIco={ele.icon} classNameIco={"OBC-card"} title={ele.title} paragraph={ele.paragraph}></BenefitsCard>
            )
          })}
        </div>
    </div>
